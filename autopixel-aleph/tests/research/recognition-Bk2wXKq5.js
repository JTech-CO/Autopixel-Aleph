import{cn as e}from"./DhUcoEdH.js";var t=e({default:()=>n}),n=`Welcome to WPlace, a platform to share and explore pixel art creations!
`,r=e({default:()=>i}),i=`We have just launched a new update focused on **personalization**!
...
`,a=e({default:()=>ee}),ee=`This update brings several improvements and fixes for a smoother experience:
...
`,o=e({default:()=>s}),s=`This patch focuses on interface stability across devices and a better moderation workflow:
...
`,c=e({default:()=>l}),l=`Import any image and position it over the map as a painting guide! Access overlays from the **new button in the main sidebar**.
...
`,u=e({default:()=>d}),d=`With v1.3.0, we’re reducing the moderation intervention and giving more freedom to the players to better match Wplace’s core idea: a living canvas shaped by the community.
...
`,ce=e({default:()=>le}),le=`## Improvements
...
`,ue=e({default:()=>de}),de=`## Improvements
...
`,fe=e({default:()=>pe}),pe=`## Improvements
...
`,ve=e({default:()=>ye}),ye=`## Improvements
...
`,xe=e({default:()=>Se}),Se=`## Improvements
...
`,Te=Object.entries(Object.assign({"./markdown/1.0.0 - Welcome to WPlace!.md":t,"./markdown/1.1.0 - ✨ More Like You Update.md":r,"./markdown/1.1.1 - 🛠️ Quality & Cosmetics Improvements.md":a,"./markdown/1.1.2 - 🧰 UI Fixes & Moderation Improvements.md":o,"./markdown/1.2.0 - 🖼️ Pixel Overlays & Achievement Frames.md":c,"./markdown/1.3.0 - 🛠️ Moderation Adjustments, Hotspots and Improved Anti-Cheat System.md":u,"./markdown/1.3.1 - 🛠️  Hotfixes and Opt-out from Hotspots copy.md":f,"./markdown/1.3.2 - 🤖 Anti-cheat improvements and Google Drive overlay sync.md":m,"./markdown/1.3.3 - ⚽ World Cup Predictions and Cosmetics & Anti-cheat Improvements.md":g,"./markdown/1.4.0 - 🛡️ The New Alliance System.md":v,"./markdown/1.4.1 - 🛡️ Alliance System Fixes.md":b,"./markdown/1.4.10 - 🛠️ Mobile Overlay Rendering.md":S,"./markdown/1.4.11 - 🛠️ Phone Verification Fixes.md":w,"./markdown/1.4.12 - 🛠️ Alliance Overlay Reliability.md":E,"./markdown/1.4.2 - 🛠️ Headquarters Preview Reliability.md":O,"./markdown/1.4.3 - 🛠️ Alliance Usability Fixes.md":A,"./markdown/1.4.4 - 🧭 Alliance Canvas Overlays.md":M,"./markdown/1.4.5 - 🎨 Alliance Canvas Tools and Map Display.md":P,"./markdown/1.4.6 - 🛠️ Map Interaction Reliability.md":I,"./markdown/1.4.7 - 🖼️ Alliance Overlays and Asset Studio.md":R,"./markdown/1.4.8 - 🛠️ Overlay Reliability.md":B,"./markdown/1.4.9 - 🛍️ Mobile Overlay Fixes.md":H,"./markdown/1.5.0 - 💎 Premium Cosmetics.md":W,"./markdown/1.5.1 - 💎 More Prism Per Purchase.md":te,"./markdown/1.5.2 - 🛠️ Store Purchase Reliability.md":q,"./markdown/1.5.3 - 🛠️ Account and Payment Reliability.md":Y,"./markdown/1.5.4 - 💳 Checkout Payment Options.md":Z,"./markdown/1.5.5 - 🛠️ Map Loading Reliability.md":ne,"./markdown/1.5.6 - 🛠️ Paint Charge Reliability.md":ie,"./markdown/1.6.0 - 🖼️ Overlay Studio.md":oe,"./markdown/1.6.1 - 🛠️ Overlay Reliability.md":ce,"./markdown/1.6.2 - 🖼️ Layer Opacity & Overlay Peek.md":ue,"./markdown/1.6.3 - 🖼️ Overlay Studio Reliability and Imports.md":fe,"./markdown/1.6.4 - 🛠️ Alliance Award Eligibility.md":me,"./markdown/1.6.5 - 🎨 Overlay Studio and Alliance Tools.md":ge,"./markdown/1.6.6 - 🛠️ Alliance Overlay Details.md":ve,"./markdown/1.6.7 - 🛠️ Overlay Performance and Alliance Reliability.md":be,"./markdown/1.6.8 - 🎨 Studio Controls and Event Wrap-up.md":xe,"./markdown/1.6.9 - 🧑‍🎨 More Studio Tools and Collapsible Palette.md":Ce})).map(([e,t])=>{var n,r;let i=(n=e.split(`/`).at(-1))==null?void 0:n.replace(`.md`,``),a=i==null||(r=i.split(`-`)[0])==null?void 0:r.trim();return{version:a,title:(i==null?void 0:i.split(`-`).slice(1).join(`-`).trim())??a,markdown:t.default}}).sort((e,t)=>e.version.localeCompare(t.version,void 0,{numeric:!0}));export{Te as t};