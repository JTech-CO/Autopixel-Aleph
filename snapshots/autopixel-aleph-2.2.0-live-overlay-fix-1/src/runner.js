...
(() => {
  ...
  function diagnostics() {
    return {
      version: '2.2.0', build: 'live-overlay-fix-1', native: {...NS.native?.diagnostic}, elapsedMs: elapsedMs(), painted: state.paintedTotal, passPainted: state.done, overlayRestarts: state.restarts, matched: state.matching,
